...
public class EncryptDecrypt {
	 private final String propertyFileName;
	    ...
	    private final String ENCRYPTOR_KEY = "1qazXDR%tgbNJI(";
	     ...
	     */
	    private void encryptPropertyValue() throws Exception {
...
//	        	 System.out.println("User password is already encrypted.\n ");
	    ...
	    private String decryptPropertyValue() throws Exception {
